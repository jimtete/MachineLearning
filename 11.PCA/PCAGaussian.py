...
fig2 = plt.figure()
fig2 = plt.plot(num_components,acc_train,"c-",label="Train")
fig2 = plt.plot(num_components,acc_test,"g--",label="Test")
fig2 = plt.xlabel("Αριθμός βαρών, num_components")
fig2 = plt.ylabel("Ποσοστό Acurracy")
plt.xlim([1,784])
#plt.xlim([1,120])
#plt.ylim([0.4,1])
